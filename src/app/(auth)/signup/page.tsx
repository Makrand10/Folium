  ...
  return (
    <main className="max-w-md mx-auto p-6">
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <button disabled={loading} className="w-full border rounded p-2">{loading ? "…" : "Sign up"}</button>
      </form>
      <p className="text-sm mt-3">Already have an account? <a className="text-blue-600" href="/signin">Sign in</a></p>
    </main>
  );
}
